...
public class CuerposGeometricosExcepciones {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Solo esta permitido el ingreso de numeros enteros, se ha producido una excepcion: " + e.getMessage());
    }
        lector.close();
    }    
    ...
    public static double resolverPrisma(){
        ...
        System.out.println("Solo esta permitido el ingreso de numeros, se ha producido una excepcion: " + e.getMessage());
        lector.nextLine();
        }catch(ArithmeticException e){
            System.out.println("La division entre cero no esta permitida: " + e.getMessage());
        }
    }
        return areaLateral;
    }
